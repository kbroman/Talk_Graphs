...
for(i in 1:nrow(health))
  axis(side=2, at=i, health[i,1],
       col.axis = ifelse(i %% 5 == 0, blue, "white"))
abline(v=seq(5, 15, by=5), col="gray20")
points(health[,2], 1:25, col = ifelse(1:25 %% 5 == 0, blue, "white"))
...
plot(0, 0, type="n", xlab="Health care spending (% GDP)",
     ...
     ylim=c(nrow(health), 0)+0.5, yaxs="i")
for(i in 1:nrow(health))
  axis(side=2, at=i, health[o[i],1],
       col.axis = ifelse(i %% 5 == 0, blue, "white"))
abline(v=seq(5, 15, by=5), col="gray20")
points(health[o,2], 1:25, col = ifelse(1:25 %% 5 == 0, blue, "white"))
@
