...
plot(0,0,type="n", xlim=c(0, mx), ylim=c(0, mx), xlab="", ylab="", 
     xaxt="n", yaxt="n", xaxs="i", yaxs="i")
library(plotrix)
draw.circle(5, 4, sqrt(17/pi),     nv=251, lwd=2, border="wheat", col="wheat")
text(5, 4, "Wheat (17 Gbp)", col=bgcolor, cex=1.5)
draw.circle(mult*0.9, mult*1.7, sqrt(0.145/pi), nv=251, lwd=2, border="lightgreen", col="lightgreen")
text(1.2*mult, 0.5*mult, "Arabidopsis (0.145 Gbp)", col="lightgreen", adj=c(0, 0.5))
draw.circle(4*mult,  6*mult,  sqrt(3.2/pi),   nv=251, lwd=2, border="Orchid", col="Orchid")
